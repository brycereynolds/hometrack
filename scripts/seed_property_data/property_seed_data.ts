  const propertyData = [
      {
        ...
        lotSizeAcres: 0.04,
        yearBuilt: 2003,
        propertyType: 'TOWNHOME', stories: 2,
        constructionMaterials: [], roof: 'Composition', foundation: ['Slab'],
        features: {
          pool: false,
          garage: true,
          fireplace: false,
      ...
      },
      {
        ...
        bathsHalf: 1,
        sqft: 1390,
        lotSqft: 0.2924471992653811,
        lotSizeAcres: 0.0,
        yearBuilt: 2015,
        propertyType: 'TOWNHOME', stories: 3,
        constructionMaterials: [], roof: 'Composition, Shingle', foundation: ['Slab'],
        features: {
          pool: false,
          garage: true,
          fireplace: false,
      ...
      },
      {
        ...
        lotSizeAcres: 0.15,
        yearBuilt: 1975,
        propertyType: 'SINGLE_FAMILY', stories: 1,
        ...
        middleSchool: 'DartmouthMiddle_1', middleSchoolDistrict: 'None',
      ...
      },
      {
        ...
        constructionMaterials: [], roof: 'Composition', foundation: ['Concrete Perimeter'],
        features: {
          pool: false,
          garage: false,
          fireplace: false,
        ...
        middleSchool: 'RaymondJFisherMiddle', middleSchoolDistrict: 'None',
      ...
      },
      {
        ...
        middleSchool: 'WillowGlenMiddle', middleSchoolDistrict: 'None',
      ...
      },
      {
        ...
        yearBuilt: 1962,
        propertyType: 'SINGLE_FAMILY', stories: 1,
        constructionMaterials: [], roof: 'Composition, Shingle', foundation: ['Crawl Space'],
        features: {
          pool: false,
          garage: true,
          fireplace: false,
        ...
        middleSchool: 'RollingHillsMiddle_1', middleSchoolDistrict: 'None',
      ...
      },
      {
        ...
        architecturalStyle: 'Queen Anne / Victorian',
      ...
      },
      {
        ...
        lotSizeAcres: 0.17,
        yearBuilt: 1910,
        propertyType: 'SINGLE_FAMILY', stories: 2,
        constructionMaterials: [], roof: 'Composition, Fiberglass', foundation: ['Concrete Perimeter'],
        features: {
          pool: true,
          garage: false,
          fireplace: false,
        ...
        middleSchool: 'HerbertHooverMiddle_1', middleSchoolDistrict: 'None',
