...
async function main() {
  ...
  const propertyData = [
    ...
    },
    {
      ...
      roomsCount: 12,
      taxAssessedValue: 2917230, taxAnnualAmount: 33000, taxYear: 2025, parcelNumber: '12004109',
      walkabilityScore: 82, transitScore: 55, bikeScore: 88,
      neighborhood: 'University South',
      elementarySchool: 'Addison Elementary', elementarySchoolDistrict: 'Palo Alto Unified',
      middleSchool: 'Frank S. Greene Jr. Middle', middleSchoolDistrict: 'Palo Alto Unified',
      highSchool: 'Palo Alto High', highSchoolDistrict: 'Palo Alto Unified',
      nearbySchools: [
        { name: 'Addison Elementary School', type: 'public', level: 'Elementary', distance: 0.3, rating: 8, grades: 'K-5', link: 'https://www.greatschools.org/california/palo-alto/5603-Addison-Elementary-School/', isAssigned: true },
        { name: 'Frank S. Greene Jr. Middle', type: 'public', level: 'Middle', distance: 1.3, rating: 9, grades: '6-8', link: 'https://www.greatschools.org/california/palo-alto/5614-Frank-S.-Greene-Jr.-Middle/', isAssigned: true },
        { name: 'Palo Alto High School', type: 'public', level: 'High', distance: 0.8, rating: 10, grades: '9-12', link: 'https://www.greatschools.org/california/palo-alto/5617-Palo-Alto-High-School/', isAssigned: true },
      ],
      photos: [
    ...
    },
    {
      ...
      roomsCount: 7,
      taxAssessedValue: 2063623, taxAnnualAmount: 25111, taxYear: 2025, parcelNumber: '37511012',
      walkabilityScore: 58, transitScore: 38, bikeScore: 70,
      neighborhood: 'Rancho Rinconada',
      elementarySchool: 'Sedgwick Elementary', elementarySchoolDistrict: 'Cupertino Union',
      middleSchool: 'Hyde Middle', middleSchoolDistrict: 'Cupertino Union',
      highSchool: 'Cupertino High', highSchoolDistrict: 'Fremont Union',
      nearbySchools: [
        { name: 'D. J. Sedgwick Elementary School', type: 'public', level: 'Elementary', distance: 0.5, rating: 9, grades: 'K-5', link: 'https://www.greatschools.org/california/cupertino/5448-D.-J.-Sedgwick-Elementary-School/', isAssigned: true },
        { name: 'Warren E. Hyde Middle School', type: 'public', level: 'Middle', distance: 0.8, rating: 10, grades: '6-8', link: 'https://www.greatschools.org/california/cupertino/5437-Warren-E.-Hyde-Middle-School/', isAssigned: true },
        { name: 'Cupertino High School', type: 'public', level: 'High', distance: 0.3, rating: 10, grades: '9-12', link: 'https://www.greatschools.org/california/cupertino/5496-Cupertino-High-School/', isAssigned: true },
      ],
      photos: [
    ...
    },
    {
      ...
      roomsCount: 7,
      taxAssessedValue: 256448, taxAnnualAmount: 4510, taxYear: 2025, parcelNumber: '43433011',
      ...
      nearbySchools: [
        { name: 'Willow Glen Elementary School', type: 'public', level: 'Elementary', distance: 0.5, rating: 5, grades: 'K-5', link: 'https://www.greatschools.org/california/san-jose/5696-Willow-Glen-Elementary-School/', isAssigned: true },
        { name: 'Willow Glen Middle School', type: 'public', level: 'Middle', distance: 1.4, rating: 5, grades: '6-8', link: 'https://www.greatschools.org/california/san-jose/5698-Willow-Glen-Middle-School/', isAssigned: true },
        { name: 'Willow Glen High School', type: 'public', level: 'High', distance: 1.4, rating: 8, grades: '9-12', link: 'https://www.greatschools.org/california/san-jose/5697-Willow-Glen-High-School/', isAssigned: true },
      ],
      photos: [
    ...
    },
    {
      ...
      roomsCount: 9,
      taxAssessedValue: 2394824, taxAnnualAmount: 29270, taxYear: 2025, parcelNumber: '17027041',
      ...
      nearbySchools: [
        { name: 'Oak Knoll Elementary School', type: 'public', level: 'Elementary', distance: 0.4, rating: 9, grades: 'K-6', isAssigned: true },
        { name: 'Hillview Middle School', type: 'public', level: 'Middle', distance: 1.4, rating: 8, grades: '7-8', isAssigned: true },
        { name: 'Menlo-Atherton High School', type: 'public', level: 'High', distance: 0.6, rating: 10, grades: '9-12', isAssigned: true },
      ],
      photos: [
    ...
    },
    {
      ...
      features: {
        ...
        heating: ['Wall heater', 'Electric'], cooling: ['Air Conditioner', 'Ceiling Fan'],
        appliances: ['Dryer', 'Microwave', 'Washer'],
        flooring: ['Carpet'], laundry: ['In Unit'],
        interiorFeatures: ['Ceiling Fan(s)', 'Large Closets'],
        exteriorFeatures: ['Courtyard', 'EV Charging Stations'],
        communityFeatures: ['Clubhouse', 'Fitness Center', 'Pool'],
        securityFeatures: ['Gated Community'],
        fencing: 'Complex perimeter', view: 'Courtyard', waterfront: false,
        patioAndPorch: ['Patio'],
      },
      parkingSpaces: 1, garageSpaces: 0, parkingFeatures: ['Covered', 'Off Street'],
      roomsCount: 4,
      ...
      neighborhood: 'Raynor',
      elementarySchool: 'Laurelwood Elementary', elementarySchoolDistrict: 'Santa Clara Unified',
      middleSchool: 'Peterson Middle', middleSchoolDistrict: 'Sunnyvale',
      highSchool: 'Adrian Wilcox High', highSchoolDistrict: 'Santa Clara Unified',
      nearbySchools: [
        { name: 'Laurelwood Elementary School', type: 'public', level: 'Elementary', distance: 0.4, rating: 10, grades: 'K-5', link: 'https://www.greatschools.org/california/santa-clara/5634-Laurelwood-Elementary-School/', isAssigned: true },
        { name: 'Marian A. Peterson Middle School', type: 'public', level: 'Middle', distance: 1.0, rating: 8, grades: '6-8', link: 'https://www.greatschools.org/california/sunnyvale/5639-Marian-A.-Peterson-Middle-School/', isAssigned: true },
        { name: 'Adrian Wilcox High School', type: 'public', level: 'High', distance: 2.0, rating: 8, grades: '9-12', link: 'https://www.greatschools.org/california/santa-clara/5647-Adrian-Wilcox-High-School/', isAssigned: true },
      ],
      photos: [
    ...
    },
    {
      ...
      propertyType: 'SINGLE_FAMILY', stories: 1, architecturalStyle: 'Craftsman',
      ...
      features: {
        ...
        flooring: ['Hardwood', 'Slate'], laundry: ['Washer', 'Dryer'],
      ...
      parkingSpaces: 3, garageSpaces: 2, parkingFeatures: ['Garage - Attached', 'Off-street', 'On-street'],
      ...
      nearbySchools: [
        { name: 'Terrell Elementary School', type: 'public', level: 'Elementary', distance: 0.2, rating: 2, grades: 'K-5', link: 'https://www.greatschools.org/california/san-jose/5692-Terrell-Elementary-School/', isAssigned: true },
        { name: 'John Muir Middle School', type: 'public', level: 'Middle', distance: 1.2, rating: 5, grades: '6-8', link: 'https://www.greatschools.org/california/san-jose/5679-John-Muir-Middle-School/', isAssigned: true },
        { name: 'Gunderson High School', type: 'public', level: 'High', distance: 1.2, rating: 6, grades: '9-12', link: 'https://www.greatschools.org/california/san-jose/5667-Gunderson-High-School/', isAssigned: true },
      ],
      photos: [
        { url: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=800&h=600&fit=crop', caption: 'Front exterior' },
      ],
      lastSoldPrice: 840000, lastSoldDate: '2016-07-08',
      zillowId: 19703350,
      zillowUrl: 'https://www.zillow.com/homedetails/809-Midvale-Ln-San-Jose-CA-95136/19703350_zpid/',
      zestimate: 1701400,
      rentZestimate: 5554,
      priceHistory: [
        { date: '2016-07-08', event: 'Sold', price: 840000, pricePerSqft: 398, source: 'Public Record' },
        { date: '2016-06-02', event: 'Listed for sale', price: 869000, pricePerSqft: 411, source: 'MLSListings Inc' },
        { date: '2015-06-26', event: 'Listed for sale', price: 879000, pricePerSqft: 416, source: 'MLSListings Inc' },
      ],
      taxHistory: [
        { year: 2025, taxAmount: 13233, value: 974886 },
        { year: 2024, taxAmount: 12474, value: 956124 },
        { year: 2023, taxAmount: 12235, value: 937376 },
        { year: 2022, taxAmount: 11795, value: 907504 },
        { year: 2021, taxAmount: 11543, value: 889712 },
      ],
